      ...
      <!--flash message end-->
				...
				<div class="card">
					...
					<div class="card-header header-elements-inline">
						<h5 class="card-title">
							<a href="#"  onClick="resetForm('addForm')" data-toggle="modal" data-target="#addClient" class="btn-primary btn"><i class="fas fa-plus-circle"></i> Add User</a>
						</h5>
        ...
        <div class="table-responsive" >
              ...
              ?>  
                ...
                <td>{{$i++}}</td>
                        ...
                        echo '
                          <a href="#" onClick="edit('.$id.',\''.$name.'\' ,\''.$email.'\',\''.$phone.'\',\''.$email.'\')" data-toggle="modal" data-target="#editClient" class="dropdown-item"><i class="fas fa-edit"></i> Edit</a>
                        ';
                        ?>
