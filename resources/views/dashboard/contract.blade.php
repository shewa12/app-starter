...
<div class="container">
	...
	<div class="row">
		<div class="warn">
			<img src="{{url('public/images/warning.png')}}" alt="image" style="width:40px;height: 40px; margin-right: 10px;float: left;">
		...
		<div class="contract-id">
			<div class="panel">
				...
				<div class="panel-body">
					<input type="" name="kontraktId" required>
				</div>				
			</div>	
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td>
						<input type="" name="Fullmaktshaver" value="">
					</td>
				</tr>
			</tbody>
		</table>		
